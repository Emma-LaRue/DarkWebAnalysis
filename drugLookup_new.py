...
psilocybin = ['Cubensis', 'Little smoke', 'Magic mushrooms', 'Purple passion', 'Shrooms', 'psilocybin', 'mushrooms', 'mushroom', 'Golden Teachers']
...
marijuana = ['Astro Yurf','Bhang', 'Blunt', 'Bud', 'Blaze', 'Dagga', 'Dope', 'Dry high', 'Ganja', 'Grass', 'Hemp', 'Herb', 'Home grown', 'Joint', 'Mary Jane', 'Pot', 'Reefer', 'Roach', 'Sinsemilla', 'Skunk', 'Smoke', 'Texas tea', 'THC', 'Trees', 'Weed', 'marijuana', 'k2', 'kush', 'fruity pebbles', 'tutti frutti', 'haze', 'grand daddy purple', 'blue dream', 'white widow', 'citrus blast', 'gorrilla glue', 'durban poison', 'sativa', 'indica', 'hybrid', 'purple trainwreck', 'diesel', 'orange crush', 'cannabis', 'medical', 'gelato', 'wedding cake', 'star dawg', 'california', 'amber shatter', 'buds', 'lemon tree', 'dry-sift', 'kief', 'tangerine dream', 'cheesecake', 'green krack', 'green crack', 'maui', 'trainwreck', 'chemdawg', 'candyland', 'sunset sherbert', 'granddaddypurple', 'white buffalo', 'moby dick', 'kush//indoor', 'cookies//indoor', 'strain', 'strains', 'blueberry', 'strawberry', 'stardawg', 'blue 69', 'flying dutchman', 'jungle boys', 'black domina', 'super lemon', 'amnesia', 'thai', 'chokladkola', 'joint', 'sour cookie', 'evergreen', 'blue twist', 'pine', 'glaze', 'og', 'skywalker', 'flower', 'chemdog', 'cherry bomb', 'ortega', 'critical bilbo', 'mj', 'dank', 'alpujarrena', 'white russian', 'northern lights', 'lemon', 'jack herer', 'mr. nice', 'hydro', 'gorilla glue', 'zkittlez', 'cheese', 'indoor', 'outdoor', 'spice 5F-ADB blend', '1.75 Teen', 'gorilla glue!', 'AmnesiaUltimate', 'Cali orange', 'Blue Dream', 'purepowerplant', 'darkstar', 'odv3', 'heavy hitters', 'Kalashnikova' '455G//Grand Daddy Purple?GDP', 'blue goo', 'Sunset Sherbert', 'golden goat', 'zerozero', 'golden goat', '#Honey Moroccan Blonde', 'Afghan hero', 'brownies', 'Canna Butter', 'ARMAGEDDON', 'silverhaze', 'alaskan thunder fuck', 'brownies-', 'ARMAGEDDON', 'cbd#thc#coco#oil#capsules', 'girl scout cookies', 'agent']
...
antidepressant = ['zoloft', 'prozac', 'moclobemide']
...
prescription = ['amoxicillin', 'azithromycin', 'clindamycin', 'ampicillin', 'levofloxacin',
                'lidocaine', 'benzocaine', 'ondansetron', 'soma', 'hydroxyzine', 'amlodipine', 'clonidine', 'ramipril',
                'zolpidem', 'propofol', 'lyrica', 'gabapentin', 'phenobarbital', 'pregabalin']

steroids_and_hormones = ['testosterone', 'testesterone', 'trenbolone', 'dbol', 'boldenone', 'dnp', 'sustanon', 'clomid', 'tamoxifen', 'anastrozole', 'cytotec', 'clenbuterol', 'duromine', 'dianabol']

erectile_dysfunction = ['viagra', 'sildenafil', 'tadaga', 'kamagra', 'cialis', 'levitra', 'dapoxetine', 'vidalista', '?viagra+cialis', 'viagra+cialis+levitra']
...
stimulant = ['modafinil', 'dexamfetamine', 'armodafinil', 'ephedrine',
             'khat', 'bath salts', 'Arctic blasts', 'Aura', 'Avalance', 'Avalanche', 'Blizzard', 'Bloom',
			   ...
			   'Abyssinian tea', 'African salad', 'Catha', 'Chat', 'Kat', 'Oat', 'khat', 'mephedrone', 'mephedorne', 'meow meow',
             'methylphenidate', 'concerta', 'ritalin','Diet coke','JIF', 'Kiddie cocaine', 'Kiddie coke', 'MPH', 'Poor man’s cocaine',
			   'R-ball', 'Skippy', 'Skittles', 'Smarties', 'The Smart Drug', 'Vitamin R',
             'ampthetamine', 'Bennies', 'Black beauties', 'Crosses','LA Turnaround', 'Truck drivers', 'Uppers', 'adderall',
			   'benzedrine', 'amphetamine', 'dextroamphetamine', 'adderral', 'amfetamin', 'speedpaste', 'vyvanse', '3-fluorophenmetrazine', 'clobenzorex',
			   'dexamphetamine', '4-fluoramphetamine', '4-fmp', 'amfetamiini', 'D-methylated', 'adderall(amphetamine', 'SPEED?PASTE']
 
opioid = ['codeine','Captain Cody', 'Cody', 'Doors and fours', 'Lean','Loads', 'Pancakes and syrup', 'Purple drank', 
			   'Schoolboy', 'Sizzurp', 'dihydrocodeine', 'dxm',
         'hydromorphone', 'Dillies', 'Footballs', 'Smack', 'dilaudid',
         'fentanyl', 'Apache', 'China girl', 'Dance fever', 'Goodfella', 'Murder 8',
			'Tango and Cash', 'TNT', 'Hydrocodone', 'Dihydrocodeinone','Vike', 'Watson 387', 'vicodine', 'carfentanil', 'Cyclopropyl'
         'meperidine', 'Demmies'
         'morphine', 'Miss Emma', 'White stuff', 'oramorph'
         'oxymorphone', 'Biscuits', 'Blue heaven', 'Heavenly blues', 'Mrs. O', 'O bombs', 'Octagons', 'Stop signs',
         'vicondin', 'tramadol', 'tapentadol', 'norco', 'hydrocodone']

dissociative = ['mxe', 'pcp', 'phencyclidine', 'Angel dust', 'Boat', 'Hog', 'Love boat', 'Peace pill']

psychedelic = ['salvia', 'divinorum', 'nbome', 'nboh',
               'mescaline', 'Buttons', 'Cactus', 'Mesc', 'peyote',
               '2c-b', 'cornetto', '2-cb', '2cb', '2C', 'hcl', 'hydrochloride salt', 'tusi']

opioid_treatment = ['methadone', 'naltroxone', 'buprenorphine', 'vivitrol', 'naloxone', 'suboxone', 'subutex', 'Amidone', 'Fizzies']
...
# info = ['license','licence','ssn','cpn', 'account','accounts', 'passport','passports', 'profile','profiles', 'template','templates', 'login','logins','amazon','hbo', 'xbox' ,'full information', 'full info', 'fake id', 'hulu','ssndob']
